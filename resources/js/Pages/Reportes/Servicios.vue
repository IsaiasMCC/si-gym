  ...
  watch: {
    form: {
      ...
      handler: throttle(function() {
        this.$inertia.get('/servicios/reportes', pickBy(this.form), { preserveState: true })
      }, 150),
    }
  },
  methods: {
    ...
    exportar(tipo) {
      ...
      window.open(`/servicios/reportes/export?tipo=${tipo}&${new URLSearchParams(query)}`, '_blank')
    }
  }
}
</script>